...
public class WeekUtil {
	public static void main(String args[]) {
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-22 12:12:12"));
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-21 12:12:12"));
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-20 12:12:12"));
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-19 12:12:12"));
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-18 12:12:12"));
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-17 12:12:12"));
		System.out.println(isOddDayOfWeekFromDateTime("2019-12-16 12:12:12"));
	}
	 ...
	 * @param strDateTime
	 */
	public static void CalculateWeekDay(String strDateTime) {
		int y = getYearFromDateTime(strDateTime);
		int m = getMonthFromDateTime(strDateTime);
		int d = getDayFromDateTime(strDateTime);
		if (m < 1 || m > 12) {
